...
users_db = {
    "gustom": {
    "username": "gustom",
    "full_name": "gustom torres",
    "email": "gustom@gmail.com",
    "disabled": False,#activo
    "password": "$2a$12$TZEn3ig4QCs0204j775l6ekNrCPhfQd7P4OzmxuIh49mJL.rjUd6W" #password: 123456
    },
    "jadrian": {
    "username": "jadrian",
    "full_name": "jose torres",
    "email": "adrian@gmail.com",
    "disabled": True,#inactivo
    "password": "$2a$12$FiXXXQxdRLN7mKGhtmIziO3scuG8FibEtUctyCBRhpY1g/oHcVHDi" #password: gustom
    }  
}    
